// slightly edited freeRTOS config from the template
...
/* Specifically for PSoC 6: Normal assert() semantics without relying on the 
provision of an assert.h header file. */
#if defined(NDEBUG)
